...
---
- CS + AI degree<br>
- Startup internship - shipped core production features<br>
- Strong fundamentals: OS, networking, databases, concurrency<br>
...
- Running a startup<br>
- Looking for a backend engineer who thinks in tradeoffs<br>
